...
import das3.cdf  # Extra functionality that depends on pycdf, will fail 
...
ds['coord:frequency'] = das3.Variable(a, "Hz", axis=1)
ds['coord:time'] = das3.Variable(b, "s")
ds['data:amp'] = das3.Variable(c, "V/m")

ds.sortAsc('time','freq')

# In memory conversion
cdf = das3.cdf.convert(ds)

# Write to a file
das3.cdf.write(ds, sys.stdout)
